Shader "Custom/TornadoSwipe"
{
    ...
    SubShader
    {
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
            ...
            float2 noise = tex2D(_NoisePattern, float2(u,v) * 1/_NormalScale + float2((pow(v,4)*10)+_Time.y,_Time.y+v*3)*_RotationSpeed).xw;
            o.Albedo = noise.x * _Color.rgb;
            o.Metallic = 0;
            o.Smoothness = 0;
            o.Alpha = noise.y;
        }
