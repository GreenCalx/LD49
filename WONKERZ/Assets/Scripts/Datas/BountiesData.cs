...
public static class BountiesData
{
    ...
    public static readonly List<BountyArray.AbstractBounty> datas = new List<BountyArray.AbstractBounty>
    {
        ...
        new BountyArray.TrackScoreBounty( 1, 1, "default", "default", new CosmeticElement(), new BountyArray.TrackScoreConstraint(Constants.SN_JUNKYARD_TRACK, DIFFICULTIES.EASY, new BountyArray.TimeConstraint(1,0) ) ),
