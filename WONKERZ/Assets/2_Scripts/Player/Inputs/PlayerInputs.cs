...
public class PlayerInputs
{
    ...
    public PlayerInputs()
    {
        ...
        controller.AddInput((int)InputCode.TriggerPower, new GameInputButton("Trigger Power", "Launch effect of equiped power.", new Controller.InputCode(Controller.JoystickButtonsCode.A), new Controller.InputCode(KeyCode.E)));
