...
public static class BountiesData
{
    ...
    public static readonly List<BountyArray.AbstractBounty> datas = new List<BountyArray.AbstractBounty>
    {
        ...
        new BountyArray.TrackScoreBounty( 4, 1, "Master Driver I", "Beat Desert in Hard under 20min",new CosmeticElement("cc_black", COLORIZABLE_CAR_PARTS.MAIN, "CarColorBlack", ""), new BountyArray.TrackScoreConstraint(Constants.SN_DESERT_TOWER, DIFFICULTIES.HARD, new BountyArray.TimeConstraint(20,0) ) ),
        new BountyArray.TrackScoreBounty( 4, 2, "Medium Hustler I", "Beat Desert in Medium under 30min", new CosmeticElement("cc_yellow", COLORIZABLE_CAR_PARTS.MAIN, "CarColorYellow", ""), new BountyArray.TrackScoreConstraint(Constants.SN_DESERT_TOWER, DIFFICULTIES.MEDIUM, new BountyArray.TimeConstraint(30,0) ) ),
        new BountyArray.TrackScoreBounty( 4, 3, "Easy Rider I", "Beat Desert in Easy under 40min" , new CosmeticElement("cc_pink", COLORIZABLE_CAR_PARTS.MAIN, "CarColorPink", ""), new BountyArray.TrackScoreConstraint(Constants.SN_DESERT_TOWER, DIFFICULTIES.EASY, new BountyArray.TimeConstraint(40,0) ) ),
        new BountyArray.TrackEventBounty( 4, 4, "Rookie", "Finish the tutorial track", new CosmeticElement("cc_yellow", COLORIZABLE_CAR_PARTS.MAIN, "", "CarColorYellow"), new BountyArray.EventTriggerConstraint(Constants.SN_INTRO, UniqueEvents.UEVENTS.GP_IntroComplete) ),
