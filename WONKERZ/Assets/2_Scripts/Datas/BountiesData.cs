...
public static class BountiesData
{
    ...
    public static readonly List<BountyArray.AbstractBounty> datas = new List<BountyArray.AbstractBounty>
    {
        ...
        new BountyArray.TrackEventBounty( 4, 4, "Rookie", "Finish the tutorial track", new CosmeticElement("wheelskin1", COLORIZABLE_CAR_PARTS.WHEELS, "", "Skin1"), new BountyArray.EventTriggerConstraint(Constants.SN_INTRO, UniqueEvents.UEVENTS.GP_IntroComplete) ),
