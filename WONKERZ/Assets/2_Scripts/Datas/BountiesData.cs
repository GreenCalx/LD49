...
public static class BountiesData
{
    ...
    public static readonly List<BountyArray.AbstractBounty> datas = new List<BountyArray.AbstractBounty>
    {
        ...
        new BountyArray.TrackEventBounty( 0, 3, "Desert Pot", "Chase the fake pot in the Desert", new CosmeticElement("wheelskin1", COLORIZABLE_CAR_PARTS.WHEELS, "", "Skin1"), new BountyArray.EventTriggerConstraint(Constants.SN_DESERT_TOWER, UniqueEvents.UEVENTS.BNTY_DesertBreakingPot) ),
        ...
        new BountyArray.TrackEventBounty( 0, 9, "Desert W.O.N.K.E.R.Z", "Get all the WONKERZ letters in one run in the Desert", new CosmeticElement("wheel_metal", COLORIZABLE_CAR_PARTS.WHEELS, "WheelColorMetal", ""), new BountyArray.EventTriggerConstraint(Constants.SN_DESERT_TOWER, UniqueEvents.UEVENTS.BNTY_DesertWONKERZ) ),
        ...
        new BountyArray.TrackEventBounty( 4, 4, "Welcome to WONKERZ", "Finish the tutorial track", new CosmeticElement("wheelskin1", COLORIZABLE_CAR_PARTS.WHEELS, "", "Skin1"), new BountyArray.EventTriggerConstraint(Constants.SN_INTRO, UniqueEvents.UEVENTS.GP_IntroComplete) ),
