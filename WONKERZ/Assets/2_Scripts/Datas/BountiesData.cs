...
public static class BountiesData
{
    ...
    public static readonly List<BountyArray.AbstractBounty> datas = new List<BountyArray.AbstractBounty>
    {
        ...
        new BountyArray.TrackEventBounty( 1, 1, "Sawed ways", "Trick over the saws in the desert", new CosmeticElement("carskin1", COLORIZABLE_CAR_PARTS.MAIN, "", "Skin1"), new BountyArray.EventTriggerConstraint(Constants.SN_DESERT_TOWER, "Sawed Ways" ) ),
        ...
        new BountyArray.TrackEventBounty( 4, 4, "Welcome to WONKERZ", "Finish the tutorial track", new CosmeticElement("wheelskin1", COLORIZABLE_CAR_PARTS.WHEELS, "", "Skin1"), new BountyArray.EventTriggerConstraint(Constants.SN_INTRO, "WelcomeToWonkerz") ),
