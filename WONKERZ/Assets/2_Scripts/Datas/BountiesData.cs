...
public static class BountiesData
{
    ...
    {
        new BountyArray.TrackScoreBounty( 0, 0, "default", "default", new CosmeticElement(), new BountyArray.TrackScoreConstraint(Constants.SN_JUNKYARD_TRACK, DIFFICULTIES.EASY, new BountyArray.TimeConstraint(1,0) ) ),
        new BountyArray.TrackScoreBounty( 0, 1, "default", "default", new CosmeticElement(), new BountyArray.TrackScoreConstraint(Constants.SN_JUNKYARD_TRACK, DIFFICULTIES.EASY, new BountyArray.TimeConstraint(1,0) ) ),
        new BountyArray.TrackScoreBounty( 0, 2, "default", "default", new CosmeticElement(), new BountyArray.TrackScoreConstraint(Constants.SN_JUNKYARD_TRACK, DIFFICULTIES.EASY, new BountyArray.TimeConstraint(1,0) ) ),
        ...
        new BountyArray.TrackEventBounty( 0, 6, "The kid", "Complete The Kid's challenge in forest island.", new CosmeticElement("StraightLines", COLORIZABLE_CAR_PARTS.JUMP_DECAL, "StraightLinesJumpDecal", ""), new BountyArray.EventTriggerConstraint(Constants.SN_HUB, UniqueEvents.UEVENTS.BNTY_TheKidFloorIsLava0) ),
        ...
        new BountyArray.TrackScoreBounty( 0, 9, "default", "default", new CosmeticElement(), new BountyArray.TrackScoreConstraint(Constants.SN_JUNKYARD_TRACK, DIFFICULTIES.EASY, new BountyArray.TimeConstraint(1,0) ) ),
        ...
        new BountyArray.TrackEventBounty( 1, 1, "Sawed ways", "Trick over the saws in the desert", new CosmeticElement("carskin1", COLORIZABLE_CAR_PARTS.MAIN, "", "Skin1"), new BountyArray.EventTriggerConstraint(Constants.SN_DESERT_TOWER, UniqueEvents.UEVENTS.BNTY_SawedWays ) ),
        ...
        new BountyArray.TrackEventBounty( 3, 4, "Desert W.O.N.K.E.R.Z", "Get all the WONKERZ letters in one run in the Desert", new CosmeticElement("wheel_metal", COLORIZABLE_CAR_PARTS.WHEELS, "WheelColorMetal", ""), new BountyArray.EventTriggerConstraint(Constants.SN_DESERT_TOWER, UniqueEvents.UEVENTS.BNTY_DesertWONKERZ) ),
        ...
        new BountyArray.TrackScoreBounty( 4, 1, "Master Driver I", "Beat Desert in Hard under 30min",new CosmeticElement("gold car paint", COLORIZABLE_CAR_PARTS.MAIN, "CarColorGold", ""), new BountyArray.TrackScoreConstraint(Constants.SN_DESERT_TOWER, DIFFICULTIES.HARD, new BountyArray.TimeConstraint(30,0) ) ),
        new BountyArray.TrackScoreBounty( 4, 2, "Medium Hustler I", "Beat Desert in Medium under 30min", new CosmeticElement("black car paint", COLORIZABLE_CAR_PARTS.MAIN, "CarColorBlack", ""), new BountyArray.TrackScoreConstraint(Constants.SN_DESERT_TOWER, DIFFICULTIES.MEDIUM, new BountyArray.TimeConstraint(30,0) ) ),
        new BountyArray.TrackScoreBounty( 4, 3, "Easy Rider I", "Beat Desert in Easy under 30min" , new CosmeticElement("yellow car paint", COLORIZABLE_CAR_PARTS.MAIN, "CarColorYellow", ""), new BountyArray.TrackScoreConstraint(Constants.SN_DESERT_TOWER, DIFFICULTIES.EASY, new BountyArray.TimeConstraint(30,0) ) ),
        new BountyArray.TrackEventBounty( 4, 4, "Rookie", "Finish the tutorial track", new CosmeticElement("pink car paint", COLORIZABLE_CAR_PARTS.MAIN, "CarColorPink", ""), new BountyArray.EventTriggerConstraint(Constants.SN_INTRO, UniqueEvents.UEVENTS.GP_IntroComplete) ),
        ...
        new BountyArray.TrackEventBounty( 5, 4, "Desert Pot", "Chase the fake pot in the Desert", new CosmeticElement("wheelskin1", COLORIZABLE_CAR_PARTS.WHEELS, "", "Skin1"), new BountyArray.EventTriggerConstraint(Constants.SN_DESERT_TOWER, UniqueEvents.UEVENTS.BNTY_DesertBreakingPot) ),
